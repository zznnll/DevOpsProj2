...
public class AdminRegister extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/admindetails", "root",
					"");
			...
			if (i > 0) {
				...
				writer.println("<h1>" + "You have successfully entered admins's information to database!" + "</h1>");
				writer.close();
			}
		}
